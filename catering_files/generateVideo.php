...
if (typeof parent.videojs == 'undefined') {
	...
	videoJSStyle.setAttribute("href", "//cdn2.editmysite.com/css/videojs/video.4.3.css?buildTime=1526341683");
	...
	videoJSScript.setAttribute("src", "//www.weebly.com/weebly/libraries/videojs/video.4.3.js?buildTime=1526341683");
...
function firstVideo() {
	parent.videojs.options.flash.swf = '//www.weebly.com/weebly/libraries/videojs/video-js.swf?buildTime=1526341683';
	plantVideo();
}
...
function plantVideo() {
	var currVideo = jQuery(
		'<div class="video-js-holder">'
			+ '<video id="video-968530135366555762" poster="/uploads/1/9/9/8/19984411/catering_slide_show_oct2013_735.jpg" class="video-js vjs-big-play-centered" style="display: none;">'
				+ '<source src="//videos.weebly.com/uploads/1/9/9/8/19984411/catering_slide_show_oct2013_735.mp4" type="video/mp4" />'
			+ '</video>'
		+ '</div>'
	);
	parent.document.getElementById('wsite-video-container-968530135366555762').appendChild(currVideo.get(0));
	...
	var videoPlayer = videojs("video-968530135366555762", {
		"controls": true,
		"autoplay": false,
		'techOrder': ['html5','flash'],
		"preload": "none",
		"poster": "/uploads/1/9/9/8/19984411/catering_slide_show_oct2013_735.jpg",
		"width": 501,
		"height": 282
	}, function(){
		...
		if (ie8Mode) {
			...
			currVideo.find('.vjs-poster').css({
				'background-image': 'url("/uploads/1/9/9/8/19984411/catering_slide_show_oct2013_735.jpg")',
